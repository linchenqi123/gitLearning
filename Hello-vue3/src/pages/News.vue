  ...
  <div class="news">
    <ul>
        <li v-for="news in newsList" :key="news.id">
            <button @click="showDetail(news)">查看新闻详情</button>
            <RouterLink :to="{
...
let newsList = reactive([
    {id:1,title:'十种养生法则',content:'养生法则1：保持心情愉快，心情愉快是健康长寿的重要保证。心情愉快有利于消化吸收，有利于血液循环，有利于免疫功能的提高。'},
...
function showDetail(news:NewsInterface){
    router.push({
        name:'NewsDetail',
        params:{
            id:news.id,
